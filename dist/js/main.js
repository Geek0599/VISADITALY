(() => {
    ...
    let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
        ...
        if (targetBlockElement) {
            ...
            if (noHeader) {
                ...
                headerItemHeight = document.querySelector(headerItem).offsetHeight - 1;
            }
            let options = {
    ...
    function mainBgParallax() {
        let mainBg = document.querySelector(".main__img-ibg");
        if (mainBg) {
            let targetY = 0;
            let currentY = 0;
            ...
            function updatePosition() {
                ...
                mainBg.style.transform = `translate3d(0,${currentY}px,0)`;
